...
#    Updated: 2020/12/02 00:00:46 by mac              ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ALLOC_SRCS = ft_realloc.c ft_calloc.c
...
CONV_SRCS = ft_atoi.c ft_atoi_skip.c ft_digittoint.c ft_xdigittoint.c \
	    ft_tolower.c ft_toupper.c ft_todigit.c ft_itoa.c
...
LST_SRCS = ft_delcontent.c  ft_lstadd_front.c ft_lstdel.c ft_lstdelone.c \
...
MEM_SRCS = ft_memalloc.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memdel.c \
	   ft_memmove.c ft_memset.c ft_memccpy.c

MISC_SRCS = ft_insn_shrui.c ft_detect_char.c ft_detect_null.c ft_isaligned.c \
...
STR_SRCS = ft_bzero.c ft_revstr.c ft_strcat.c ft_strchr.c \
	   ...
	   ft_substr.c ft_strtrim.c ft_strlcpy.c ft_strnlen.c

SRCS = $(CHAR_SRCS) $(CONV_SRCS) $(REDO_PRINTF_SRCS) $(MATH_SRCS) \
		  $(MEM_SRCS) $(MISC_SRCS) $(PUT_SRCS) $(STR_SRCS) $(ALLOC_SRCS) \
		  $(LST_SRCS)
#
# Build
#
...
$(NAME): $(OBJS)
	@$(BUILD_LIB) && echo "$(NAME) created"

$(OBJ_DIR):
	@mkdir -p $@

# The pipe means the following dependencies are order-only.
# Make will ignore their timestamp.
# https://stackoverflow.com/questions/1950926/create-directories-using-make-file
$(OBJ_DIR)/%.o: %.c | $(OBJ_DIR)
	$(COMP)

clean:
	@rm -rf $(OBJ_DIR) 2> /dev/null && echo "Object files removed."
